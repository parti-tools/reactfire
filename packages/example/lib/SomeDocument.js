...
var _FirebaseDocumentContainer = require("@parti/reactfire-data/FirebaseDocumentContainer");

var _FirebaseDocumentContainer2 = _interopRequireDefault(_FirebaseDocumentContainer);
  ...
  _createClass(SomeDocument, [{
    ...
    value: function render() {
      return React.createElement(
        _FirebaseDocumentContainer2.default,
        {
          path: "/test/sample",
